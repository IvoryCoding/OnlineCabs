...
public class ManageBookingViewDisplay extends JFrame{
    BackendModelSetup theBackendModel;
    
    JButton backToMain;
    JButton changeBookingButton;
    ...
    public ManageBookingViewDisplay(BackendModelSetup aBackend) {
    ...
    private void initComponents() {
        ...
        this.changeBookingButton = new JButton();
        this.changeBookingButton.setText("Save Changes");
        ...
        c.ipady = 10;
        c.ipadx = 10;
        mainDisplayPane.add(this.changeBookingButton, c);
        ...
        c.ipady = 10;
        c.ipadx = 10;
        mainDisplayPane.add(this.getInfoButton, c);
